...
> **Примечание: Приложение [Bonepayment Wallet](https://bonepayment.com) было разработано компанией [Horizontal Systems](https://horizontalsystems.io), которой принадлежит авторство данных руководств.**
